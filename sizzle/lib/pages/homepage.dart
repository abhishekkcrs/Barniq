...
//0xFFFFF8E1
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Color.fromARGB(255, 244, 228, 175),
        elevation: 0,
      ...
      body: Container(
        ...
        child: Stack(
          children: [
            Column(
              children: [
                // Pinned Search Bar and Menu
                Container(
                  color: Color.fromARGB(255, 244, 228, 175),
                  child: Column(
                    children: [
                      Padding(
                        padding:
                ...
                Expanded(
                  child: ListView(
                    ...
                    children: [
                      ...
                      SizedBox(height: 12),
                      // Super Summer Savings (poster style)
                      superSummerSavingsPoster(),
                      SizedBox(height: 24),
                    ],
                  ),
                ),
